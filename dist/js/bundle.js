...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.clearView = exports.renderResult = exports.getInput = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar getInput = exports.getInput = function getInput() {\n  return _base.elements.searchInput.value;\n};\n\nvar renderResult = exports.renderResult = function renderResult(items) {\n  try {\n    items.forEach(renderDiscription);\n  } catch (err) {\n    console.log(err);\n  }\n};\nvar renderDiscription = function renderDiscription(item) {\n  var descCharacterLimit = 280;\n  var titleCharacterLimit = 50;\n  var discHTML = '\\n  <li class=\"results__item\">\\n  <a class=\"results__link\" href=\"' + item.volumeInfo.previewLink + '\" target=\"blank\">\\n      <figure class=\"results__fig\">\\n          <img src=\"' + getImg(item) + '\" alt=\"Test\">\\n      </figure>\\n      <div class=\"results__data\">\\n          <h4 class=\"results__name\">' + textLimiter(item.volumeInfo.title, titleCharacterLimit) + '</h4>\\n          <h6 class=\"results__author\">' + item.volumeInfo.authors + '</h6>\\n          <p class=\"results__description\">' + textLimiter(getDesc(item), descCharacterLimit) + '</p>\\n      </div>\\n  </a>\\n</li>';\n\n  _base.elements.searchResList.insertAdjacentHTML('beforeend', discHTML);\n};\n\nvar clearView = exports.clearView = function clearView() {\n  _base.elements.searchResList.innerHTML = '';\n};\n\nfunction getImg(item) {\n  return item.volumeInfo.imageLinks ? item.volumeInfo.imageLinks.smallThumbnail : 'https://weloveindiebooks.com/wp-content/uploads/2019/01/book-256.png';\n}\n\nfunction getDesc(item) {\n  return item.volumeInfo.description ? item.volumeInfo.description : 'No description';\n}\n\nvar textLimiter = function textLimiter(text, limit) {\n  var newText = [];\n  if (text.length > limit) {\n    text.split(' ').reduce(function (acc, cur) {\n      if (acc + cur.length <= limit) {\n        newText.push(cur);\n      }\n      return acc + cur.length;\n    }, 0);\n    return newText.join(' ') + '...';\n  } else {\n    return text;\n  }\n};\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");
